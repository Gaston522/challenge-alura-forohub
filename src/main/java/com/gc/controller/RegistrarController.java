...
public class RegistrarController {
    ...
    public ResponseEntity registrarUsuario(@RequestBody @Valid UsuarioRegistroDTO usuarioRegistroDTO){
        ...
        Optional<UsuarioEntity> optionalUsuario = Optional.ofNullable(usuarioRepository.findByNombre(usuarioRegistroDTO.nombre()));
        ...
        }else return new ResponseEntity<>("El usuario ya exite", HttpStatus.NOT_ACCEPTABLE);
    }
    ...
    public ResponseEntity<String> registrarTopico(@RequestBody @Valid TopicoRegistroDTO registroTopicoDTO){
        ...
        Optional<UsuarioEntity> optionalUsuario = Optional.ofNullable(usuarioRepository.findByNombre(registroTopicoDTO.usuario()));
